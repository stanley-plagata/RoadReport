...
<a href=map>
    ...
    <img src="cone.gif" alt="cone" class="imgFlip"style="width:20px;height:25px">
        ...
        <form:form id="reportHazardForm" method="POST" action="reportHazardProcess" modelAttribute="hazard">
             <table>
                <tr>
                    <td><form:label path="hazardType" style="color: white;">Hazard Type: </form:label></td>
                    <td><form:input path="hazardType" name="hazardType" id="hazardType"/></td>
                </tr>
                <tr>
