    ...
    <img src="cone.gif" alt="cone" class="imgFlip"style="width:20px;height:25px">
        ...
        <a href="register">Register</a>
            ...
            <tr>
                ...
                <td><form:label path="field1" style="color: white;">Company / First Name </form:label></td>

                <td><form:input path="field1" name="field1" id="field1" /></td>

            </tr>
            
            <tr>
             
            	<td><form:label path="field2" style="color: white;">Service / Last Name</form:label></td>

                <td><form:input path="field2" name="field2" id="field2" /></td>
