...
<a href=map>
    ...
    <img src="cone.gif" alt="cone" class="imgFlip"style="width:20px;height:25px">
		...
		<a href="" style="float: right; align: center;">Logout</a>
    </div>

        <c:forEach items="${hazards}" var="hazard" varStatus="h">
            <div style="
    ...
    padding: 5px
    			">
                <p style="color: black">Hazard Type: ${hazard.hazardType}</p>
                <p style="color: black">Address: ${hazard.address}</p>
                <p style="color: black">Severity: ${hazard.severity}</p>
                <div style="text-align:center; padding-bottom: 10px">
                <a href="<c:url value='/resolveHazardProcess/${hazards[h.index].reportID}' />" > <button class="hover" id="resolve">Resolve Hazard</button></a>  </div>        
            </div>
        </c:forEach>
